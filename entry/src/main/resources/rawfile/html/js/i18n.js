...
const translations = {
    'zh-Hans': {
        ...
        "u-sub-title-2": "ClashNEXT的所有权和运作权归小白软件团队所有。在本服务条款中简称\"本团队\"或称为\"我们\"。使用ClashNEXT产品及服务将视为您同意以下使用条款。",
        "u-h2-1": "1. 仅供个人使用",
        ...
        "u-h2-2": "2. 知识产权",
        "u-p-2": "用户承认本团队拥有对ClashNEXT的所有权利，包括但不限于所有知识产权。\"知识产权\"指在专利法、版权法、商业机密法、商标法、反不正当竞争法等法中规定的所有权利以及其中的所有应用、更新、扩展和恢复，无论在现在还是以后在全球范围内实施和生效。用户同意不会修改、改编、翻译ClashNEXT、创作ClashNEXT的派生作品、通过反编译、反向工程、反汇编或其它方式从ClashNEXT得到源代码。用户同意不会删除、掩盖或更改本团队或任何第三方的版权声明、商标或其它所有权声明。",
        "u-h2-3": "3. 用户隐私制度",
        ...
        "p-sub-title-1": "本政策仅适用于本公司（以下简称「我们」）的产品「ClashNEXT」及其相关服务。",
    ...
    'en-Latn': {
        ...
        "u-sub-title-2": "All ownership and operational rights of ClashNEXT belong to Xiaobai Software Team. In this Service Agreement, referred to as \"the Team\" or \"we\". Use of ClashNEXT products and services constitutes acceptance of the following terms.",
        ...
        "u-p-2": "Users acknowledge that the Team holds all rights to ClashNEXT, including but not limited to all intellectual property rights. \"Intellectual Property\" refers to all rights under patent law, copyright law, trade secret law, trademark law, anti-unfair competition law, etc., including all applications, updates, extensions, and restorations, both current and future, implemented and effective worldwide. Users agree not to modify, adapt, translate, create derivative works of ClashNEXT, or obtain source code through decompilation, reverse engineering, disassembly, or other means. Users agree not to remove, obscure, or alter any copyright notices, trademarks, or other ownership declarations of the Team or any third party.",
        ...
        "p-p-6-5": "693903194",
        "p-h2-7": "Developer: Xiaobai Software Team",
        "p-h2-8": "App Name: ClashNEXT"
    },
    'zh-TW': {
        "u-main-title": "使用者條款",
        "u-sub-title": "更新日期：2025年5月1日",
        "u-sub-title-2": "ClashNEXT的所有權與營運權歸小白軟體團隊所有。在本服務條款中簡稱\"本團隊\"或稱為\"我們\"。使用ClashNEXT產品及服務將視為您同意以下使用條款。",
        "u-h2-1": "1. 僅供個人使用",
        ...
        "u-h2-2": "2. 智慧財產權",
        "u-p-2": "使用者承認本團隊擁有ClashNEXT之所有權利，包含但不限於所有智慧財產權。\"智慧財產權\"係指專利法、著作權法、營業秘密法、商標法、公平交易法等法規所規範之所有權利，以及其應用、更新、擴展與恢復，無論現行或未來於全球範圍內生效。使用者同意不修改、改編、翻譯ClashNEXT、創作衍生作品，亦不透過反編譯、反向工程、反組譯或其他方式取得原始碼。使用者同意不刪除、遮蔽或變更本團隊或第三方之著作權聲明、商標或其他所有權標示。",
        "u-h2-3": "3. 使用者隱私權政策",
        ...
        "p-sub-title": "更新日期：2025年5月11日",
        "p-sub-title-1": "本政策僅適用於本公司（以下簡稱「我們」）之產品「ClashNEXT」及其相關服務。",
    ...
    'zh-HK': {
        "u-main-title": "用戶協議",
        "u-sub-title": "更新日期：2025年5月1日",
        "u-sub-title-2": "ClashNEXT嘅所有權同運作權歸小白軟件團隊所有。喺本服務條款中簡稱\"本團隊\"或稱為\"我哋\"。使用ClashNEXT產品及服務將視為您同意以下使用條款。",
        "u-h2-1": "1. 僅供個人使用",
        ...
        "u-h2-2": "2. 知識產權",
        "u-p-2": "用戶承認本團隊擁有對ClashNEXT嘅所有權利，包括但不限於所有知識產權。\"知識產權\"指喺專利法、版權法、商業機密法、商標法、反不正當競爭法等法中規定嘅所有權利以及其中嘅所有應用、更新、擴展同恢復，無論喺宜家定以後喺全球範圍內實施同生效。用戶同意唔會修改、改編、翻譯ClashNEXT、創作ClashNEXT嘅派生作品、通過反編譯、反向工程、反彙編或其它方式從ClashNEXT得到源代碼。用戶同意唔會刪除、掩蓋或更改本團隊或任何第三方嘅版權聲明、商標或其它所有權聲明。",
        "u-h2-3": "3. 用戶私隱制度",
        ...
        "p-sub-title": "更新日期：2025年5月11日",
        "p-sub-title-1": "本政策僅適用於本公司（以下簡稱「我哋」）嘅產品「ClashNEXT」及其相關服務。",
